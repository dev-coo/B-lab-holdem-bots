"""CLI entry point: `uv run python -m holdem_bot_gto_lean`.

**스캐폴드 단계**: BalancedStrategy 재사용. 봇 고유 GTO-lean 전략이 생기면 교체.
"""
...
def _build_strategy(settings: Settings) -> BalancedStrategy:
    # TODO: GTO-lean 전용 파라미터 (낮은 raise_thr, 높은 bluff freq 등) 로 교체.
